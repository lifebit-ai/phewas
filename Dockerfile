...
LABEL authors="Phil Palmer, Christina Chatzipantsiou, Marcos Camara Donoso" \
      description="Docker image containing all software requirements for the pheWAS pipeline"
...
ENV PATH /opt/conda/envs/phewas/bin:$PATH

#Install pheWAS in R env
COPY setup.R /


# Dump the details of the installed packages to a file for posterity
RUN conda env export --name phewas > phewas.yml
